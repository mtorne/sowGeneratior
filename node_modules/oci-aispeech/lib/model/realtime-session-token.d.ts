...
export declare namespace RealtimeSessionToken {
    function getJsonObj(obj: RealtimeSessionToken): object;
    function getDeserializedJsonObj(obj: RealtimeSessionToken): object;
}
