...
export declare namespace CreateRealtimeSessionTokenDetails {
    function getJsonObj(obj: CreateRealtimeSessionTokenDetails): object;
    function getDeserializedJsonObj(obj: CreateRealtimeSessionTokenDetails): object;
}
