...
export declare namespace EntityListDataset {
    function getJsonObj(obj: EntityListDataset, isParentJsonObj?: boolean): object;
    const datasetType = "ENTITY_LIST";
    function getDeserializedJsonObj(obj: EntityListDataset, isParentJsonObj?: boolean): object;
}
