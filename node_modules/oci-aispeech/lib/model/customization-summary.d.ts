...
export declare namespace CustomizationSummary {
    function getJsonObj(obj: CustomizationSummary): object;
    function getDeserializedJsonObj(obj: CustomizationSummary): object;
}
