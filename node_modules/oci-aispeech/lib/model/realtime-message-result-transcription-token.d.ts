...
export declare namespace RealtimeMessageResultTranscriptionToken {
    enum Type {
        Word = "WORD",
        Punctuation = "PUNCTUATION"
    }
    function getJsonObj(obj: RealtimeMessageResultTranscriptionToken): object;
    function getDeserializedJsonObj(obj: RealtimeMessageResultTranscriptionToken): object;
}
