...
export declare namespace CustomizationCollection {
    function getJsonObj(obj: CustomizationCollection): object;
    function getDeserializedJsonObj(obj: CustomizationCollection): object;
}
