...
export declare namespace PullRequestChangeSummaryMetrics {
    function getJsonObj(obj: PullRequestChangeSummaryMetrics): object;
    function getDeserializedJsonObj(obj: PullRequestChangeSummaryMetrics): object;
}
