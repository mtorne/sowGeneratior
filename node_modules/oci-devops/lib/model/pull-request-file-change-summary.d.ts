...
export declare namespace PullRequestFileChangeSummary {
    function getJsonObj(obj: PullRequestFileChangeSummary): object;
    function getDeserializedJsonObj(obj: PullRequestFileChangeSummary): object;
}
