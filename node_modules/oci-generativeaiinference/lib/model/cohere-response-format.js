...
exports.CohereResponseFormat = void 0;
const model = __importStar(require("../model"));
const common = require("oci-common");
var CohereResponseFormat;
(function (CohereResponseFormat) {
    function getJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "TEXT":
                    return model.CohereResponseTextFormat.getJsonObj(jsonObj, true);
                case "JSON_OBJECT":
                    return model.CohereResponseJsonFormat.getJsonObj(jsonObj, true);
                default:
    ...
    CohereResponseFormat.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "TEXT":
                    return model.CohereResponseTextFormat.getDeserializedJsonObj(jsonObj, true);
                case "JSON_OBJECT":
                    return model.CohereResponseJsonFormat.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.type}`);
            }
    ...
    CohereResponseFormat.getDeserializedJsonObj = getDeserializedJsonObj;
})(CohereResponseFormat = exports.CohereResponseFormat || (exports.CohereResponseFormat = {}));
//# sourceMappingURL=cohere-response-format.js.map