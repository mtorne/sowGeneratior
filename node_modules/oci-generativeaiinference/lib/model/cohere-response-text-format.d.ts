...
export declare namespace CohereResponseTextFormat {
    function getJsonObj(obj: CohereResponseTextFormat, isParentJsonObj?: boolean): object;
    const type = "TEXT";
    function getDeserializedJsonObj(obj: CohereResponseTextFormat, isParentJsonObj?: boolean): object;
}
