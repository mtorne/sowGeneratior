...
export declare namespace ApplyGuardrailsResult {
    function getJsonObj(obj: ApplyGuardrailsResult): object;
    function getDeserializedJsonObj(obj: ApplyGuardrailsResult): object;
}
