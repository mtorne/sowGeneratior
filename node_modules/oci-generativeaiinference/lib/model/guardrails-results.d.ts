...
export declare namespace GuardrailsResults {
    function getJsonObj(obj: GuardrailsResults): object;
    function getDeserializedJsonObj(obj: GuardrailsResults): object;
}
