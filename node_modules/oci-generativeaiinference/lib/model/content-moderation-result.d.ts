...
export declare namespace ContentModerationResult {
    function getJsonObj(obj: ContentModerationResult): object;
    function getDeserializedJsonObj(obj: ContentModerationResult): object;
}
