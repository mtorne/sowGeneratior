...
export declare namespace ContentModerationConfiguration {
    function getJsonObj(obj: ContentModerationConfiguration): object;
    function getDeserializedJsonObj(obj: ContentModerationConfiguration): object;
}
