...
(function (ToolDefinition) {
    function getJsonObj(obj) {
        ...
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "FUNCTION":
                    return model.FunctionDefinition.getJsonObj(jsonObj, true);
                default:
    ...
    ToolDefinition.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "FUNCTION":
                    return model.FunctionDefinition.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.type}`);
            }
    ...
    ToolDefinition.getDeserializedJsonObj = getDeserializedJsonObj;
})(ToolDefinition = exports.ToolDefinition || (exports.ToolDefinition = {}));
