...
exports.GuardrailsInput = void 0;
const model = __importStar(require("../model"));
const common = require("oci-common");
var GuardrailsInput;
(function (GuardrailsInput) {
    function getJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "TEXT":
                    return model.GuardrailsTextInput.getJsonObj(jsonObj, true);
                default:
    ...
    GuardrailsInput.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "TEXT":
                    return model.GuardrailsTextInput.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.type}`);
            }
    ...
    GuardrailsInput.getDeserializedJsonObj = getDeserializedJsonObj;
})(GuardrailsInput = exports.GuardrailsInput || (exports.GuardrailsInput = {}));
//# sourceMappingURL=guardrails-input.js.map