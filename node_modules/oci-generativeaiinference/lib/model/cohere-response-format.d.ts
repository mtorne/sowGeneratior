...
export declare namespace CohereResponseFormat {
    function getJsonObj(obj: CohereResponseFormat): object;
    function getDeserializedJsonObj(obj: CohereResponseFormat): object;
}
