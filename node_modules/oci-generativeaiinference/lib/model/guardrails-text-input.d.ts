...
export declare namespace GuardrailsTextInput {
    function getJsonObj(obj: GuardrailsTextInput, isParentJsonObj?: boolean): object;
    const type = "TEXT";
    function getDeserializedJsonObj(obj: GuardrailsTextInput, isParentJsonObj?: boolean): object;
}
