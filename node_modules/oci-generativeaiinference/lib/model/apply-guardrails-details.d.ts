...
export declare namespace ApplyGuardrailsDetails {
    function getJsonObj(obj: ApplyGuardrailsDetails): object;
    function getDeserializedJsonObj(obj: ApplyGuardrailsDetails): object;
}
